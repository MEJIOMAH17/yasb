...
interface LimitTest<TABLE : Table<TABLE, DRIVER_DATA_SOURCE>, F, D, DRIVER_DATA_SOURCE> where F : TransactionFactory<D, DRIVER_DATA_SOURCE>, D : DatabaseDialect<DRIVER_DATA_SOURCE>, D : SupportsLimit {
