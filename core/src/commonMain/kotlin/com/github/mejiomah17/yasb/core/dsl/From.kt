...
fun <DRIVER_DATA_SOURCE, DRIVER_STATEMENT> Select<DRIVER_DATA_SOURCE, DRIVER_STATEMENT>.from(source: SelectionSource<DRIVER_DATA_SOURCE, DRIVER_STATEMENT>): SelectFromQuery<DRIVER_DATA_SOURCE, DRIVER_STATEMENT> {
    return SelectFrom(this, source)
}

fun <DRIVER_DATA_SOURCE, DRIVER_STATEMENT> Delete.from(source: SelectionSource<DRIVER_DATA_SOURCE, DRIVER_STATEMENT>): DeleteFromQuery<DRIVER_DATA_SOURCE, DRIVER_STATEMENT> {
