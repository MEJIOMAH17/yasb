...
class Count<DRIVER_DATA_SOURCE, DRIVER_STATEMENT>(
    ...
    override fun databaseType(): DatabaseType<Long, DRIVER_DATA_SOURCE, DRIVER_STATEMENT> = databaseType

    override fun sql(): String = "COUNT(${expression.sql()})"
...
fun <DRIVER_DATA_SOURCE, DRIVER_STATEMENT> count(
    expression: Expression<*, DRIVER_DATA_SOURCE, DRIVER_STATEMENT>,
): Count<DRIVER_DATA_SOURCE, DRIVER_STATEMENT> = Count(expression, dialect.longType())
